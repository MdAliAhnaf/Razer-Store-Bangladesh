...
<div class = "container">
      <div class = "row">
       <div class = "col-md-6 offset-md-3 text-center border rounded bg-light my-5">
        <br>
        <h1 class = "animate-charcter_header_signup"><?php echo "<p><i>Hey! " . "<b>" .$_SESSION['adminname'] . "</b>" . " <br>Your Profile Details</i></p>"?></h1><br>
 ...
 <?php
           ...
           /* $error2 = "There is no account associated with this adminname!<br>";*/
                    echo"<script>
